...
/*   Updated: 2024/11/23 15:29:04 by aiimdih          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_flags_p(char **format, t_flags_printf *flags)
{
	while (**format)
	{
		if (**format == ' ')
...
void	handle_specifier(char specifier, va_list args, t_flags_printf *flags,
		int *count)
{
